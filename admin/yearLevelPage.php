...
<?php require('../inc/header.php'); ?>
    ...
    <div class="tab">
                    <button class="tablinks" onclick="openCity(event, 'London')" id="defaultOpen">First Semester</button>
                    <button class="tablinks" onclick="openCity(event, 'Paris')">Second Semester</button>
                    <button class="tablinks" onclick="openCity(event, 'Tokyo')">Summer Class</button>
                </div>
