...
function createCourse($data)
{
    ...
    if (count($errors) == 0) {
        ...
        header("Location: ../admin/viewdepartment.php?department_id=$departmentId");
        die;
    }
...
function createSubject($data)
{
    ...
    if (count($errors) == 0) {
        ...
        header("Location: ../admin/yearLevelPage.php?department_id=$departmentId&course_id=$courseId&yearlevel_id=$yearlevelId");
        die;
    }
